...
insert into bfkonten (id, name) values (1, 'Konto 1');

insert into bfkonten (id, name) values (2, 'Konto 2');

insert into artikelgruppen 
...
insert into bfkonten_zuordnung (gruppe, konto_id) values ('Gruppe 1', 1);